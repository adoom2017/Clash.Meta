...
pub struct TransportConfig {
    ...
    pub(crate) datagram_max_frame_size: Option<u16>,
...
impl TransportConfig {
    ...
    /// Optional bound for the advertised DATAGRAM frame size, independent of the
    /// aggregate receive queue. The receive buffer size remains an upper bound.
    /// None preserves the upstream behavior; disabling reception still disables
    /// DATAGRAM support regardless of this setting.
    pub fn datagram_max_frame_size(&mut self, value: Option<u16>) -> &mut Self {
        self.datagram_max_frame_size = value;
        self
    }
...
impl fmt::Debug for TransportConfig {
    fn fmt(&self, fmt: &mut fmt::Formatter<'_>) -> fmt::Result {
        ...
        s.field("max_concurrent_bidi_streams", max_concurrent_bidi_streams)
            ...
            .field("datagram_max_frame_size", datagram_max_frame_size)
