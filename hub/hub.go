...
func Parse(options ...Option) error {
	...
	if cfg.General.ExternalController != "" {
		go route.Start(cfg.General.ExternalController, cfg.General.ExternalControllerTLS,
			cfg.General.Secret, cfg.TLS.Certificate, cfg.TLS.PrivateKey, cfg.General.Log.LogLevel == log.DEBUG)
	}

	if cfg.General.ExternalControllerUnix != "" {
		go route.StartUnix(cfg.General.ExternalControllerUnix, cfg.General.Log.LogLevel == log.DEBUG)
	}
